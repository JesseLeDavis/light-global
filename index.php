...
<?php include('partials/header.php'); ?>
    ...
    <main>
        ...
        <!-- HERO -->
        <section class="home-hero fb-flex fb-column">
        ...
        <section class="home-about-us-section fb-flex fb-jc-spaceAround fb-column">
            <!-- WHO WE ARE -->
            <div class="who-we-are">
                <h2>Who We Are</h2>
                <p>A collective of Kingdom-driven Marketplace and NPO leaders.</p>
            </div>
